...
def baner():
    ...
    kata("""
   '\033[35;1m'============================================
   '\033[35;1m'💥DEVLOPER : FAIZUL BOFTEN
   '\033[35;1m'💥FACEBOOK " FAIZUL
   '\033[35;1m'💥WA       : 082271426251
    '\033[35;1m'============================================
            \n\t\033[90m~  ~  ~\033[92m┌∩┐\033[94m(\033[91m◣_◢\033[94m)\033[92m┌∩┐\033[90m~  ~  ~
\t\033[00m FACEBOOK CRACKING CHOKIES✔
\t\033[90m -----------------------\033[94m\n""")
def balik():
...
def mbf():
    time.sleep(0.5)
    print("\033[31;1m[\033[93m1\033[00m] Login")
    print("\033[31;1m[\033[93m2\033[00m] Update")
    print("\033[31;1m[\033[93m3\033[00m] Group WA")
    print("\033[31;1m[\033[93m4\033[00m] Exit")
    time.sleep(0.1)
    f=input("\n\033[90m> \033[1;93m")
    if f == "1":
